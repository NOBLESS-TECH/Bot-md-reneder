...
module.exports = {
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || '50937597924', // Mettez votre numéro ici
    BOT_NAME: "NOBLESS XMD",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ɴᴏʙʟᴇss ᴛᴇᴄʜ',
    ...
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbAzHEiA2pLFh3XWps0x',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '7214172448:AAHGqSgaw-zGVPZWvl8msDOVDhln-9kExas',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '8725904884'
